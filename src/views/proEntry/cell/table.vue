...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          key: 'origin',
          render: (h, r) => {
            let con = this.type_area[r.row.origin]
            return h('span',con)
          }
    ...
    filter() {
      return [
        ...
        },
        {
          ...
          name: '请选择审核状态',
          type: 'select',
          options: {1:'待提交',2:'待审核',3:'审核中',4:'审核通过',5:'审核未通过'}
        },
        {
          name: '按钮组',
          type: 'btns',
  ...
  methods: {
    ...mapActions(['manageType', 'subGroupId', 'deleteGroupId', 'regList','productAddr']),
    initTable(params) {
      this.regList(params).then(res => {
